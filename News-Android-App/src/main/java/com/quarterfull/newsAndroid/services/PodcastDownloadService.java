...
public class PodcastDownloadService extends IntentService {
    ...
    private static final String ACTION_DOWNLOAD = "com.quarterfull.newsAndroid.services.action.DOWNLOAD";

    private static final String EXTRA_RECEIVER = "com.quarterfull.newsAndroid.services.extra.RECEIVER";
    private static final String EXTRA_URL = "com.quarterfull.newsAndroid.services.extra.URL";
